...
from .service import (
    create_ldap_user, get_user, list_roles, list_users,
    reset_failed_attempts, set_user_status, update_user,
)
...
def create():
    ...
    return render_template("users/form.html", user=None, roles=list_roles())
...
def edit(user_id: int):
    ...
    return render_template("users/form.html", user=user, roles=list_roles())
