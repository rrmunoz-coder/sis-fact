...
set "ENTRY=%ROOT%scheduler_entry.py"
set "SERVICE=BillingOne_Scheduler"
...
"%NSSM%" set %SERVICE% AppStdout "%ROOT%logs\billing_one_scheduler_out.log"
"%NSSM%" set %SERVICE% AppStderr "%ROOT%logs\billing_one_scheduler_err.log"
